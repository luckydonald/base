…
, the repo (git-tracked) copy is
----------------------------------------------------------------------
Traceback (most recent call last):
  File "/home/user/git/luckydonald/base/scripts/°base/tests/test_ai_hooks_base_routing.py", line 1522, in test_memory_session_start_content_mismatch_repo_wins
    self.assertEqual(src_file.read_text(encoding="utf-8"), "drift.md content\n")
    ~~~~~~~~~~~~~~~~^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
AssertionError: 'untracked local drift\n' != 'drift.md content\n'
- untracked local drift
+ drift.md content
